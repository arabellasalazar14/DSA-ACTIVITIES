...
string insertAtTheGivenPosition(int num, int ElementAfter){
   ...
   /*if(position == -1){
        return "\nAn element after which to insert not found!\n";
    }
    if(numElem == maxElem){
        return "\nThe array is full. Please remove elements before inserting new one. \n";
    }*/
...
string deleteFromTheEnd(){
    if(numElem != 0){
        numElem--;
        return "\nAn element has been deleted form the end!\n";
    }
...
string deleteFromTheBeginning(){
    if(numElem != 0){
        ...
        numElem--;
        return "\nAn element has been deleted from the beggining!\n";
    }
    return "\nThe array is underflow! Delete is not possible.\n";
}
...
int main(){
    ...
    cout << deleteFromGivenElement(7) << endl;
      traverseArray();
    cout << deleteFromGivenElement(9) << endl;
      traverseArray();
